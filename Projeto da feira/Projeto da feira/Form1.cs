        ...
        public Color ObterCorPredominante(string caminhoImagem)
{
    ...
    WHERE u.rn = 1;";
        ...
        private void CardPlaylist(long id, string nome, string imagem, List<long> musicas)
        {
            ...
            labelNome.Font = new Font("Inter", 12, FontStyle.Bold); // Leve ajuste no tamanho se necessário para caber melhor
            labelNome.Dock = DockStyle.Fill;
            labelNome.TextAlignment = ContentAlignment.TopLeft;
     ...
     string nomeArtista)
        {
            ...
            labelartist.ForeColor =
                Cores.Roxo; // Tom mais suave parecido com o estilo Spotify/Clean
...
,@UserId
            ...
            EventArgs e)
        {
            ...
            )
            {
                ...
                guna2TrackBar1.Value =
                    (int)atual;
                tempo.Text = TimeSpan.FromSeconds((int)atual).ToString(@"m\:ss");
            ...
            EventArgs e)
        {
            ...
            if (clickCount % 2 == 1)
            {
                ...
                Display2.Dock = DockStyle.Bottom;
                this.Visible = false;
                formtable.RowStyles[0].SizeType = SizeType.Percent;
                formtable.RowStyles[0].Height = 0f;
                formtable.RowStyles[1].SizeType = SizeType.Percent;
